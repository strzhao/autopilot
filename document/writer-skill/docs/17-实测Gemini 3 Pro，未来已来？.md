...
> 作者：数字生命卡兹克
> 日期：2025-11-19
> 来源：https://news.pedaily.cn/202511/557483.shtml
...
几乎所有的指标，都是断层*，除了软件工程能力上，比GPT-5.1和CLaude Sonnet 4.5差一点，其他的，全都是断档的存在。

真的，这张表里的数据，我看*眼的时候，我以为我熬夜熬多了眼睛熬花了。

*行，Humanity’s Last Exam，这一年非常著名的评测集。
...
以后那种让AI帮你操作电脑干活的Agent，说实话，Gemini 3 Pro就是*的真神。
...
做一个模拟黑胶唱片的*写实的音乐播放器，把音频频谱和节奏可视化成炫酷的图形，功能区在底部，可以调节音量。
...
你会看到，区别*的是字体，原图的字体是类似于DIN的有版权字体，而Gemini 3 Pro，是用了无版权字体替代，所以看着不太一样，还有部分的细节也有点问题。

但是，整体的布局、样式，都已经可圈可点了。

坦率的将，我自己曾经也在厂子里合作过不少前端，很多前端开发，能在*次设计走查时，给你写成这个样子。
