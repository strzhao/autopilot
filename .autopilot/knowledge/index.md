...
## Decisions（37）
- [2026-07-10] auto-chain 文件名=id 隐含契约——AI 步骤 5b 偏离致三处 id 查找全失效（修命名非加查找，脚本零改动）；state frontmatter 实证判 brief 模式 vs 标准初始化 | tags: autopilot, auto-chain, project-mode, naming-contract, id-vs-filename, implicit-contract, ai-deviation, brief-mode, standard-init, auto-approve, script-zero-change, migration-script, dogfood, little-bee, claude-p-verification, v3.54.0 | → decisions.md
